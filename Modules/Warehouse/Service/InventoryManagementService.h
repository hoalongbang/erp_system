// Modules/Warehouse/Service/InventoryManagementService.h
#ifndef MODULES_WAREHOUSE_SERVICE_INVENTORYMANAGEMENTSERVICE_H
#define MODULES_WAREHOUSE_SERVICE_INVENTORYMANAGEMENTSERVICE_H
#include <string>
#include <vector>
#include <optional>
#include <memory>
...
#include "InventoryDAO.h"       // Inventory DAO
#include "InventoryCostLayerDAO.h" // InventoryCostLayer DAO

#include "InventoryTransactionService.h" // NEW: InventoryTransactionService dependency
...
#include "LocationService.h"    // Location Service interface (dependency)
...
namespace ERP { namespace Warehouse { namespace Services { class IInventoryTransactionService; }}} // NEW
