// Modules/Integration/Service/DeviceManagerService.h
#ifndef MODULES_INTEGRATION_SERVICE_DEVICEMANAGERSERVICE_H
#define MODULES_INTEGRATION_SERVICE_DEVICEMANAGERSERVICE_H
#include <string>
#include <vector>
#include <optional>
#include <memory>
...
#include "DeviceConfigDAO.h"    // Đã rút gọn include
...
/**
 * @brief Default implementation of IDeviceManagerService.
 * This class uses DeviceConfigDAO, and other services for logging.
 */
class DeviceManagerService : public IDeviceManagerService, public ERP::Common::Services::BaseService {
public:
    /**
     * @brief Constructor for DeviceManagerService.
     * @param deviceConfigDAO Shared pointer to DeviceConfigDAO.
     ...
     */
    DeviceManagerService(std::shared_ptr<DAOs::DeviceConfigDAO> deviceConfigDAO,
                         std::shared_ptr<ERP::Security::Service::IAuthorizationService> authorizationService,
                         std::shared_ptr<ERP::Security::Service::IAuditLogService> auditLogService,
                         std::shared_ptr<ERP::Database::ConnectionPool> connectionPool,
                         std::shared_ptr<ERP::Security::ISecurityManager> securityManager);

    std::optional<ERP::Integration::DTO::DeviceConfigDTO> registerDevice(
        const ERP::Integration::DTO::DeviceConfigDTO& deviceConfigDTO,
        const std::string& currentUserId,
        const std::vector<std::string>& userRoleIds) override;
    std::optional<ERP::Integration::DTO::DeviceConfigDTO> getDeviceConfigById(
        const std::string& deviceId,
        const std::vector<std::string>& userRoleIds = {}) override;
    std::optional<ERP::Integration::DTO::DeviceConfigDTO> getDeviceConfigByIdentifier(
        const std::string& deviceIdentifier,
        const std::vector<std::string>& userRoleIds = {}) override;
    std::vector<ERP::Integration::DTO::DeviceConfigDTO> getAllDeviceConfigs(
        const std::map<std::string, std::any>& filter = {},
        const std::vector<std::string>& userRoleIds = {}) override;
    ...
    bool deleteDeviceConfig(
        ...
        const std::string& currentUserId,
        const std::vector<std::string>& userRoleIds) override;
    bool recordDeviceEvent(
        const ERP::Integration::DTO::DeviceEventLogDTO& eventLogDTO,
        const std::string& currentUserId,
        const std::vector<std::string>& userRoleIds) override;
    std::vector<ERP::Integration::DTO::DeviceEventLogDTO> getDeviceEventLogsByDevice(
        const std::string& deviceId,
        const std::map<std::string, std::any>& filter = {},
        const std::vector<std::string>& userRoleIds = {}) override;

private:
    std::shared_ptr<DAOs::DeviceConfigDAO> deviceConfigDAO_;
...
#endif // MODULES_INTEGRATION_SERVICE_DEVICEMANAGERSERVICE_H